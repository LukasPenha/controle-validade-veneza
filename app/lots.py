...
def create():
    ...
    if request.method == 'POST':
        try:
            ...
            item = Produto(nome_produto=product['nome'], barcode=product['barcode'], marca=product['marca'],
                source='openfoodfacts', source_url=product['source_url'], plu=plu, quantidade=quantity,
    ...
    return render_template('geral/registrar_lote.html', product=product, selection=token,
