...
from . import db
from .models import Produto, Notificacao, agora_brasil
...
def verificar_validades_diarias(app):
    ...
    with app.app_context():
        ...
        produtos_vencidos_hoje = Produto.query.filter(Produto.validade == agora_brasil().date()).all()
        ...
        data_limite_critico = agora_brasil().date() + timedelta(days=3)
